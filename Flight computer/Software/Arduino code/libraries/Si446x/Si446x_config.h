...
#define SI446X_CSN			28//10
#define SI446X_SDN		24//5
#define SI446X_IRQ			23//2 // This needs to be an interrupt pin
...
#define SI446X_CSN_BIT		15//2

// Shutdown pin
#define SI446X_SDN_PORT		B//D
#define SI446X_SDN_BIT		11

// Interrupt pin
#define SI446X_IRQ_PORT		B//D
#define SI446X_IRQ_BIT		10
...
#define SI446X_INTERRUPT_NUM	10
