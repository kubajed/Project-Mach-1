...
#define SI446X_CBS_ADDRMATCH		0x01 << (7+8)
#define SI446X_CBS_ADDRMISS			0x01 << (6+8)
#endif

#define SI446X_CBS_SENT				0x01 << (5+8) ///< Enable/disable packet sent callback
//#define SI446X_CBS_RXCOMPLETE		0x01 << (4+8)
//#define SI446X_CBS_RXINVALID		0x01 << (3+8)
#define SI446X_CBS_RXBEGIN			0x01 << (0) ///< Enable/disable packet receive begin callback
//#define SI446X_CBS_INVALIDSYNC		0x01 << (5) ///< Don't use this, it's used internally by the library
